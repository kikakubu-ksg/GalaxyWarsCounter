...
Public Class Form1
    ...
    Public D_KeyWord01 As String = "pugyaa"
    Public D_KeyWord02 As String = "goodjob"
    Public D_KeyWord03 As String = "tiltu"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 受信.Click
        ...
        If CheckAny.CheckState = CheckState.Checked Then
            Label1.Text = Now + vbCrLf + "Anyからポート" + Me.RecPort.Text + "に受信受付中です"
        Else
            Label1.Text = Now + vbCrLf + permittedIp + "からポート" + Me.RecPort.Text + "に受信受付中です"
        End If
        ...
        Try
            ...
            If permitCheck = CheckState.Checked Or permittedIp = spt(0) Then
                ...
                Do
                    ...
                    'Debug.Print("6")
                Loop While client.Available And ms.Length < 1028
                'client.Close()
                '受信したデータを文字列に変換
    ...
    Private Sub 強制遮断()
        ...
        Catch
        End Try
        Me.Label1.Text = Now + vbCrLf + "遮断しました"
        Me.受信.Enabled = True
        Me.遮断.Enabled = False
    End Sub
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.キーワード1.Text = D_KeyWord01
        Me.キーワード2.Text = D_KeyWord02
        Me.キーワード3.Text = D_KeyWord03
    ...
    Private Sub TimerEvent()
        ...
        tmpstr = Me.編集文字列.Text

        tmpstr = Regex.Replace(tmpstr, "\$title", Me.タイトル.Text)
        tmpstr = Regex.Replace(tmpstr, "\$t1", Me.名称1.Text)
        tmpstr = Regex.Replace(tmpstr, "\$t2", Me.名称2.Text)
        tmpstr = Regex.Replace(tmpstr, "\$t3", Me.名称3.Text)
        tmpstr = Regex.Replace(tmpstr, "\$t4", Me.名称4.Text)
        tmpstr = Regex.Replace(tmpstr, "\$t5", Me.名称5.Text)
        tmpstr = Regex.Replace(tmpstr, "\$t6", Me.名称6.Text)
        tmpstr = Regex.Replace(tmpstr, "\$k1", Me.キーワード1.Text)
        tmpstr = Regex.Replace(tmpstr, "\$k2", Me.キーワード2.Text)
        tmpstr = Regex.Replace(tmpstr, "\$k3", Me.キーワード3.Text)
        tmpstr = Regex.Replace(tmpstr, "\$k4", Me.キーワード4.Text)
        tmpstr = Regex.Replace(tmpstr, "\$k5", Me.キーワード5.Text)
        tmpstr = Regex.Replace(tmpstr, "\$k6", Me.キーワード6.Text)
        tmpstr = Regex.Replace(tmpstr, "\$c1", Me.カウンタ1.Value.ToString)
        tmpstr = Regex.Replace(tmpstr, "\$c2", Me.カウンタ2.Value.ToString)
        tmpstr = Regex.Replace(tmpstr, "\$c3", Me.カウンタ3.Value.ToString)
        tmpstr = Regex.Replace(tmpstr, "\$c4", Me.カウンタ4.Value.ToString)
        tmpstr = Regex.Replace(tmpstr, "\$c5", Me.カウンタ5.Value.ToString)
        tmpstr = Regex.Replace(tmpstr, "\$c6", Me.カウンタ6.Value.ToString)

        Me.表示文字列.Text = tmpstr

        'shared送信HTMLを更新
        Dim tmpstr2 = Me.送信文字列.Text
    ...
    Private Sub SetSaveData(ByRef cls As SaveDataClass)
        ...
        'ANY
        cls.UMainAnyFlg = IIf(CheckAny.CheckState = CheckState.Checked, True, False)

        'IP
        cls.UMainAllowed = 許可IP.Text

        '字幕ON
        cls.UMainJimakuFlg = IIf(CheckJimaku.CheckState = CheckState.Checked, True, False)

        'ポート番号
        cls.UMainPort = RecPort.Text
        ...
        cls.UDispCounter01 = Me.カウンタ1.Value
        cls.UDispCounter02 = Me.カウンタ2.Value
        cls.UDispCounter03 = Me.カウンタ3.Value
        cls.UDispCounter04 = Me.カウンタ4.Value
        cls.UDispCounter05 = Me.カウンタ5.Value
        cls.UDispCounter06 = Me.カウンタ6.Value
    ...
    Private Sub NumericUpDown1_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NumericUpDown1.ValueChanged
        Timer1.Interval = Me.NumericUpDown1.Value
    End Sub
    ...
    Public Function GetFileNameFromPath(ByVal s As String) As String
        Dim tmp As Array = s.Split("\")

        Return tmp.GetValue(tmp.Length - 1)
    End Function
